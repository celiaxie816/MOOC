...
a = 35 * ((34.543 - 33.714)^2)
b = 35 * ((32.686 - 33.714)^2)
c = 35 * ((33.914 - 33.714)^2)
up = (a + b + c)/2
down = ((5.792^2) + (5.034^2) + (5.136^2))/3
up/down
...
#29
pre = 12/(481*482)
post = 160*(240.05-241)^2 + 161*(265.92-241)^2 + 160*(216.94-241)^2
pre * post

#23
ps = 163 / (163+138)
sc = 106 / (106+74)
total = (163+106) / (163+106+74+138)
n1 = 163+138
n2 = 106+74
z = (ps - sc)/(sqrt(total*(1-total)*((1/n1) + (1/n2))))
z
ps
...
#14
a = 0.64336 * (1-0.64336) / 293
b = 0.77474 * (1-0.77474) / 143
(0.7747 - 0.64336) + 1.96 * sqrt(a + b)

x = (227+92)/436
down = sqrt(x * (1-x) * ((1/293) + x * (1-x) * (1/143)))
up = 0.77474 - 0.64336
z = up / down
...
up = (186/297) - (71/147)
tmp = (186+71)/444
down = sqrt(tmp * (1-tmp) * ((1/297) + (1/147)))
up / down

#21
avg = (81.11111+45.44444 + 63.88889)/3
up = 9 * (((81.11111 - avg) ^2) + ((45.44444 - avg) ^2) + ((63.88889 - avg) ^ 2)) / 2
down = ((18.31969^2) + (14.99259^2) + (20.96094^2)) / 3
up / down

#24
pre = 12 / (36 * 37)
post = (12 * ((26 - 18.5)^2)) + (9 * ((7.611 - 18.5)^2)) + (15 * ((19.033 - 18.5)^2)) 
pre * post
...
#27
tmp <- data.frame(gd=c(51,206), dr = c(15,39), drp=c(37,80))

inside = (-2.472) + 0.672 + 0.397 * (2.7479 + 0.77183)
up = exp(inside)
down = 1 + up
up/down
...
#29
up = 5.1313 - 6.1078
down = sqrt(((1.51213^2)/12) + ((1.26706^2)/13))
up / down
df_up = (((1.51213^2)/12) + ((1.26706^2)/13))^2
df_down = (1/11 * ((1.51213^2)/12)^2)  + (1/12 * (((1.26706^2)/13)^2))
df = df_up / df_down
df
